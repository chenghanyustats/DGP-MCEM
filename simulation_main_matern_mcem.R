...
system.time(mcem_single_matern_3_2 <- foreach(k = 1:no_data) %dopar% {
    mcem_dgp_matern(y = YY[[k]]$y, x = YY[[k]]$x, H0 = H0_diff[[k]],
                    theta_init = c(1, 1), epsilon = 1e-3,
                    D = 500, a = 0, b = 2, n_sample = 5000, max_iter = 100,
                    lower = c(0.001, 0.001),
...
system.time(mcem_single_matern_5_2 <- foreach(k = 1:no_data) %dopar% {
    mcem_dgp_matern(y = YY[[k]]$y, x = YY[[k]]$x, H0 = H0_diff[[k]],
                    theta_init = c(1, 1), epsilon = 1e-3,
                    D = 500, a = 0, b = 2, n_sample = 5000, max_iter = 100,
                    lower = c(0.001, 0.001),
                    upper = c(1 / 0.001, 1 / 0.0001),
...
system.time(mcem_multi_matern_3_2 <- foreach(k = 1:no_data) %dopar% {
    mcem_dgp_multi_matern(y = YY[[k]]$y, x = YY[[k]]$x, H0 = H0_diff[[k]],
                          theta_init = c(1, 1), epsilon = 1e-3,
...
system.time(mcem_multi_matern_5_2 <- foreach(k = 1:no_data) %dopar% {
    mcem_dgp_multi_matern(y = YY[[k]]$y, x = YY[[k]]$x, H0 = H0_diff[[k]],
                          theta_init = c(1, 1), epsilon = 1e-3,
                          D = 500, a_vec = c(0, 1), b_vec = c(1, 2),
                          n_sample = 5000, max_iter = 100,
...
#############################################
sample_t_EM_single_lst_matern_3_2 <- lapply(mcem_single_matern_3_2, 
                                            function(x) { x$sample_t })
sample_t_EM_single_lst_matern_5_2 <- lapply(mcem_single_matern_5_2, 
                                            function(x) { x$sample_t })
sample_t_EM_multi_lst_matern_3_2 <- lapply(mcem_multi_matern_3_2, 
                                           function(x) { x$sample_t_mat })
sample_t_EM_multi_lst_matern_5_2 <- lapply(mcem_multi_matern_5_2, 
                                           function(x) { x$sample_t_mat })

sample_sig_EM_single_lst_matern_3_2 <- lapply(mcem_single_matern_3_2, 
                                              function(x) { x$sample_sig })
sample_sig_EM_single_lst_matern_5_2 <- lapply(mcem_single_matern_5_2, 
                                              function(x) { x$sample_sig })
sample_sig_EM_multi_lst_matern_3_2 <- lapply(mcem_multi_matern_3_2, 
                                             function(x) { x$sample_sig })
sample_sig_EM_multi_lst_matern_5_2 <- lapply(mcem_multi_matern_5_2, 
                                             function(x) { x$sample_sig })


EB_EM_single_lst_matern_3_2 <- lapply(mcem_single_matern_3_2, 
                                      function(x) { x$thetas[nrow(x$thetas), ] })
EB_EM_single_lst_matern_5_2 <- lapply(mcem_single_matern_5_2, 
                                      function(x) { x$thetas[nrow(x$thetas), ] })
EB_EM_multi_lst_matern_3_2 <- lapply(mcem_multi_matern_3_2, 
                                     function(x) { x$thetas[nrow(x$thetas), ] })
EB_EM_multi_lst_matern_5_2 <- lapply(mcem_multi_matern_5_2, 
                                     function(x) { x$thetas[nrow(x$thetas), ] })


#############################################
## Predictive intervals from mcem_single and mcem_multi
#############################################
...
system.time(pred_dgp_multi_lst_matern_3_2 <- foreach(k = 1:no_data) %dopar% {
    get_pi_t_sig_matern(yJ = c(YY[[k]]$y, rep(0, 2)),
                        x = YY[[k]]$x, 
                        x_test = x_test, 
                        idx_der = t(sample_t_EM_multi_lst_matern_3_2[[k]]),
                        sample_sig = sample_sig_EM_multi_lst_matern_3_2[[k]], 
                        tau = EB_EM_multi_lst_matern_3_2[[k]][1],
                        l = EB_EM_multi_lst_matern_3_2[[k]][2],
                        nu = 1.5)
})
...
system.time(pred_dgp_multi_lst_matern_5_2 <- foreach(k = 1:no_data) %dopar% {
    get_pi_t_sig_matern(yJ = c(YY[[k]]$y, rep(0, 2)),
                        x = YY[[k]]$x, 
                        x_test = x_test, 
                        idx_der = t(sample_t_EM_multi_lst_matern_5_2[[k]]),
                        sample_sig = sample_sig_EM_multi_lst_matern_5_2[[k]],
                        tau = EB_EM_multi_lst_matern_5_2[[k]][1],
                        l = EB_EM_multi_lst_matern_5_2[[k]][2],
                        nu = 2.5)
})
...
system.time(pred_dgp_single_lst_matern_3_2 <- foreach(k = 1:no_data) %dopar% {
    get_pi_t_sig_matern(yJ = c(YY[[k]]$y, rep(0, 1)),
                        x = YY[[k]]$x,
                        x_test = x_test,
                        idx_der = sample_t_EM_single_lst_matern_3_2[[k]],
                        sample_sig = sample_sig_EM_single_lst_matern_3_2[[k]],
                        tau = EB_EM_single_lst_matern_3_2[[k]][1],
                        l = EB_EM_single_lst_matern_3_2[[k]][2],
                        nu = 1.5)
})
...
system.time(pred_dgp_single_lst_matern_5_2 <- foreach(k = 1:no_data) %dopar% {
    get_pi_t_sig_matern(yJ = c(YY[[k]]$y, rep(0, 1)),
                        ...
                        sample_sig = sample_sig_EM_single_lst_matern_5_2[[k]],
                        tau = EB_EM_single_lst_matern_5_2[[k]][1],
                        l = EB_EM_single_lst_matern_5_2[[k]][2],
                        nu = 2.5)
})
stopCluster(cl)
...
save(EB_gp_matern_3_2, EB_gp_matern_5_2, 
     ...
     mcem_single_matern_3_2, mcem_single_matern_5_2, 
     mcem_multi_matern_3_2, mcem_multi_matern_5_2, 
     ...
     file = "./simulation_matern_mcem.RData")
